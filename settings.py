...
month_value_col = 'Vendido(mês)'
year_value_col = 'Vendido(ano)'

goal_col = 'Meta'
sells_per_day_col = 'Meta(dia)'
sells_per_week_col = 'Meta(semana)'
work_days_col = 'Dias Trabalhados(Semana)'
percent_sells_per_goal_col = 'Projeção Vendas(mês)/Meta %'
